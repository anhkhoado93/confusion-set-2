...
if __name__ == "__main__":
    ...
    full_confusion_set_2 = create_confusion_set(full_vocab_telex_dict, m_keystroke_distance_2)
    ...
    full_confusion_set_1 = create_confusion_set(full_vocab_telex_dict, m_keystroke_distance_1)
